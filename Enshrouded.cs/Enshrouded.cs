...
namespace WindowsGSM.Plugins
{
    public class Enshrouded : SteamCMDAgent
    {
        ...
        public Plugin Plugin = new Plugin
        {
            ...
            version = "1.1.1",
            url = "https://github.com/retr0verride/WindowsGSM.Enshrouded", // Github repository link (Best practice)
        ...
        public string QueryPort = "15637"; // Default query port
        ...
        public void GeneratePasswords()
        {
            ...
            VisitorPassword = GenerateRandomString(8); // Fix: was missing, caused empty Visitor password
        }
        ...
        public async void CreateServerCFG()
        {
            ...
            var serverConfig = new
            {
                ...
                gameSettings = new
                {
                    ...
                    perkUpgradeRecyclingFactor = 0.100000, // Fix: was 0.500000, official default is 0.1
                    perkCostFactor = 1,
                ...
                userGroups = new[]
                {
                    ...
                    {
                        name = "Visitor",
                        password = "Visitor" + VisitorPassword,
                        canKickBan = false,
                        canAccessInventories = false,
                        canEditWorld = false,
                        canEditBase = false,
        ...
        public async Task<Process> Start()
        {
            ...
            // Note: Enshrouded reads settings from enshrouded_server.json; CLI overrides are limited
